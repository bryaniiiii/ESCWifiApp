...
public class IndoorCollectManager {
    public interface CollectorListener {
        void onCollectFinished(final ArrayList<XWiFi> wifiData);
    }
    ...
    public void startScan(boolean bWifi) {
//        startSensor();
        startWireless(bWifi);
    ...
    private void startWireless(boolean bWifi) {
    ...
    private void processDataAndSend() {
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                if (collectorListener != null) {
                    collectorListener.onCollectFinished(wifiList);
                }
            }
        };
